...
//                                             </span>
//                                         </div>
//                                         <Input name='repeatPassword' placeholder='Repeat password' style={{ fontSize: '19px' }} value={formData.repeatPassword} onChange={handleChange} />
//                                     </div>
...
//                                         />
//                                     </div>
//                                     {errors.urlImage && <div className="text-danger">{errors.urlImage}</div>}
