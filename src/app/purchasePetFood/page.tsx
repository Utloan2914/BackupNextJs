...
return (
  <div>
    ...
    <div className="container-fluid" style={{ marginTop: "120px" }}>
      <div className="row">
        <div className="col-md-2 h-100 mt-20">
          <nav className="navbar flex-column align-items-stretch p-3">
            <h3 style={{ fontWeight: 'bold', marginBottom: '10px', fontSize: '22px' }}>
              PRODUCT PORTFOLIO
            </h3>
            <ul className="nav nav-pills flex-column">
  <li className="nav-item h-20">
    <a 
      className={`nav-link flex items-center h-full cursor-pointer ${category === 'PATE' ? 'bg-blue-500 text-white hover:text-black' : 'hover:bg-white hover:text-black'}`} 
  ...
  <li className="nav-item h-20">
    <a 
      className={`nav-link flex items-center h-full cursor-pointer ${category === 'DRY FOOD' ? 'bg-blue-500 text-white hover:text-black' : 'hover:bg-white hover:text-black'}`} 
  ...
  <li className="nav-item h-20">
    <a 
      className={`nav-link flex items-center h-full cursor-pointer ${category === 'TOYS' ? 'bg-blue-500 text-white hover:text-black' : 'hover:bg-white hover:text-black'}`} 
  ...
  <li className="nav-item h-20">
    <a 
      className={`nav-link flex items-center h-full cursor-pointer ${category === 'ACCESSORIES' ? 'bg-blue-500 text-white hover:text-black' : 'hover:bg-white hover:text-black'}`} 
            ...
            {filteredProducts.map((product) => (
              <Col key={product.id} md={3} className="mb-4 mt-14" style={{ height: 'auto' }}>
                <Card style={{ height: '100%' }}>
                  <Card.Img variant="top" src={product.imgSrc} style={{ height: '400px', width: '100%', objectFit: 'cover' }} />
                  <Card.Body>
                    <Card.Title style={{ color: '#272727', lineHeight: '20px', overflow: 'hidden', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', display: '-webkit-box', fontSize: '14px', fontWeight: 'bold', marginTop: '5px', height: '40px' }}>
                      {product.title}
                    </Card.Title>
                    <Card.Text style={{ color: '#272727', lineHeight: '20px', overflow: 'hidden', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', display: '-webkit-box', fontSize: '14px', fontWeight: 'normal', marginTop: '5px', height: '40px' }}>
                      {product.text}
                    </Card.Text>
                    <p className="text-danger font-bold">
                      {product.price}
