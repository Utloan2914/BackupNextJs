...
//             <div className="bg-white dark:bg-gray-800 w-[20%] p-4 rounded-2xl shadow-lg border border-gray-300 dark:border-gray-700">
//                 <div className="flex flex-col items-center">
//                     <div className="flex justify-center items-center mt-1">
//                         <Avatar
//                             alt="User Image"
//                             src={user.urlImage}
//                             className="rounded-full w-[11.5rem] h-[11.5rem] outline outline-2 outline-offset-2 outline-blue-500"
//                         />
//                     </div>
...
const ViewProfile: React.FC<ViewProfileProps> = ({ formData }) => {
    ...
    return (
        <section className="w-full pt-10 min-h-screen flex justify-center items-start dark:bg-gray-900">
            <div className="bg-white dark:bg-gray-800 w-full sm:w-[20%] p-4 rounded-2xl shadow-lg border border-gray-300 dark:border-gray-700">
                <div className="flex flex-col items-center">
                    <div className="flex justify-center items-center mt-1">
                    <Avatar
                            alt="User Image"
                    ...
                    <h2 className="title text-2xl font-bold text-center w-full mt-2">
                        {user.name}
                    </h2>
                            ...
                            <div className="w-full flex flex-col gap-2 justify-center">
                                <div className="w-full">
                                    <dl className="divide-y divide-gray-200 dark:divide-gray-700">
                                        <div className="flex flex-col pb-3">
                                            <dt className="mb-1 text-black md:text-lg dark:text-gray-400">Email</dt>
                                            <dd className="text-black" style={{ fontSize: '18px' }}>{user.email}</dd>
                                        </div>
                                        <div className="flex flex-col py-3">
                                            <dt className="mb-1 text-black md:text-lg dark:text-gray-400">Phone</dt>
                                            <dd className="text-black" style={{ fontSize: '18px' }}>{user.phone}</dd>
                                        </div>
                                        <div className="flex flex-col py-3">
                                            <dt className="mb-1 text-black md:text-lg dark:text-gray-400">Address</dt>
                                            <dd className="text-black" style={{ fontSize: '18px' }}>{user.address}</dd>
                                        </div>
                                    </dl>
                                </div>
                            </div>
