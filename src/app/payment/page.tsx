...
const PaymentInstructions = () => {
  ...
  return (
    <section className="mt-52 mb-40 w-8/10 mx-auto" style={{ display: "flex" }}>
      <div className="flex flex-col  mt-14 md:flex-row" style={{ height: '400px' , width:'900px'}}>
        {/* Phần thông báo thành công */}
        {paymentSuccess ? (
         <div className="bg-white p-4 rounded-lg mr-12 h-[400px] w-[900px]">
         <h2 className="text-3xl font-bold mb-4 text-center">Payment success!</h2>
         <p className="text-lg mb-4 text-center">Thank you for your payment. Your order has been processed.</p>
         <div className="flex justify-center gap-4">
           <a href="/purchase" className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Return to home page</a>
         </div>
       </div>
       
        ) : (
          // Đơn hàng đã mua
          <div className="flex-1 md:w-2/3 bg-white p-4 rounded-lg mr-12"style={{ height: '400px' , width:'900px'}}>
            ...
            {cart.length === 0 ? (
              ...
              <>
                ...
                <Card className="p-2 mr-4 ml-4">
                  <div className="d-flex justify-content-between font-bold text-xl">
